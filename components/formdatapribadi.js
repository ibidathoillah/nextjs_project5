...
import { MoreResources, DisplayFormikState } from '../components/helper';
  ...
  return (
    <div className={classes.root}>
      <form onSubmit={formik.handleSubmit} >
        <MyTypography className={classes.subtitle}>Informasi Pribadi</MyTypography>
        <div>
          <TextField
            id="txtNamaLengkap"
            label="Nama Lengkap *"
        ...
        <MyTypography className={classes.subtitle2}>Informasi Kewarganegaraan</MyTypography>
        <div>
          <TextField
            select
          ...
          <TextField
            ...
            value={formik.values.txtPaspor.toUpperCase()}
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
        ...
        <MyTypography className={classes.subtitle2}>Informasi Pendidikan</MyTypography>
        <div>
          <TextField
            select
            id="selectPendidikan"
        ...
        {/* informasi pajak */}
        <MyTypography className={classes.subtitle2}>Informasi Pajak Pribadi</MyTypography>
        <div>
          <InputMask
        ...
        {/* informasi keluarga */}
        <MyTypography className={classes.subtitle2}>Informasi Keluarga</MyTypography>
        <div>
          <TextField
            id="txtKartuKeluarga"
        ...
        <MyTypography className={classes.subtitle2}>Informasi Pernikahan</MyTypography>
        <div>
          <TextField
            select
            id="statusPernikahan"
        ...
        <MyTypography className={classes.subtitle2}>Informasi Ahli Waris</MyTypography>
        <div>
          <TextField
            id="namaAhliWaris"
        ...
        {/* informasi investasi */}
        <MyTypography className={classes.subtitle2}>Informasi Investasi dan Kepemilikan Rumah</MyTypography>
        <div>
          <TextField
            select
            id="jenisInvestasi"
