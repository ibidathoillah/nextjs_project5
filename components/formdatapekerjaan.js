...
const initialValues = {
  ...
  txtSisaMasaKerja: '',
  txtGajiPokok: '',
  selectTunjanganKeluarga: '',
  // txtPersentaseTunjanganKeluarga: '',
  txtNilaiTunjanganKeluarga: '',
  txtIdPns: '',
  tglTmt: '',
  txtIdInstansiInduk: '',
  txtIdSatuanKerjaInduk: '',
  txtIdLokasiKerja: '',
  selectStatus: '',
  txtIdKedudukanHukum: '',
  txtTotalPenghasilan: '',
  txtNilaiTunjanganJabatan: '',
  txtNilaiTunjanganProfesi: '',
  txtNilaiTunjanganKinerja: '',
  txtTunjanganLain3: '',
  txtTunjanganLain2: '',
  txtTunjanganLain1: '',
  txtNipLama: '',
  ...
  txtIdUnitKerja: '',
  txtIdJenisJabatan: '',
  txtIdJabatanFungsional: '',
  txtIdJabatanStruktural: '',
  txtIdJabatanFungsionalUmum: '',
  txtIdGolonganTerakhir: '',
  txtIdGolongan: '',
  noSK: '',
  tglSK: '',
  tmtGolongan: '',
